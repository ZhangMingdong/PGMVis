...
QT_MOC_LITERAL(1, 12, 11), // "updateIndex"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "from"
QT_MOC_LITERAL(4, 30, 2), // "to"
QT_MOC_LITERAL(5, 33, 12) // "indexChanged"

    },
    "GroupWidget\0updateIndex\0\0from\0to\0"
    "indexChanged"
};
...
void GroupWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateIndex((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (GroupWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GroupWidget::updateIndex)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GroupWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GroupWidget.data,
      qt_meta_data_GroupWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void GroupWidget::updateIndex(int _t1, int _t2)
{
