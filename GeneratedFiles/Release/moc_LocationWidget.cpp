...
QT_MOC_LITERAL(1, 15, 14), // "updateLocation"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 1), // "x"
QT_MOC_LITERAL(4, 33, 1), // "y"
QT_MOC_LITERAL(5, 35, 15) // "locationChanged"

    },
    "LocationWidget\0updateLocation\0\0x\0y\0"
    "locationChanged"
};
...
void LocationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateLocation((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->locationChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LocationWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LocationWidget::updateLocation)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LocationWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LocationWidget.data,
      qt_meta_data_LocationWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void LocationWidget::updateLocation(int _t1, int _t2)
{
