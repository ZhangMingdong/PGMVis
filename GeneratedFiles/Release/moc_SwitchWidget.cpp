...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SwitchWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SwitchWidget_t qt_meta_stringdata_SwitchWidget = {
    {
QT_MOC_LITERAL(0, 0, 12), // "SwitchWidget"
QT_MOC_LITERAL(1, 13, 13), // "dataIdChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 2) // "id"

    },
    "SwitchWidget\0dataIdChanged\0\0id"
};
...
void SwitchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SwitchWidget *_t = static_cast<SwitchWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataIdChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SwitchWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SwitchWidget::dataIdChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SwitchWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SwitchWidget.data,
      qt_meta_data_SwitchWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SwitchWidget::dataIdChanged(int _t1)
{
