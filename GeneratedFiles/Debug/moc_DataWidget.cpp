...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DataWidget_t qt_meta_stringdata_DataWidget = {
    {
QT_MOC_LITERAL(0, 0, 10), // "DataWidget"
QT_MOC_LITERAL(1, 11, 13), // "dataIdChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 2) // "id"

    },
    "DataWidget\0dataIdChanged\0\0id"
};
...
void DataWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DataWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataWidget::dataIdChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DataWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DataWidget.data,
      qt_meta_data_DataWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void DataWidget::dataIdChanged(int _t1)
{
