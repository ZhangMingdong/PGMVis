...
struct qt_meta_stringdata_BrushWidget_t {
    QByteArrayData data[8];
    char stringdata0[71];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BrushWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BrushWidget_t qt_meta_stringdata_BrushWidget = {
    {
QT_MOC_LITERAL(0, 0, 11), // "BrushWidget"
QT_MOC_LITERAL(1, 12, 12), // "brushChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 5), // "brush"
QT_MOC_LITERAL(4, 32, 8), // "setBrush"
QT_MOC_LITERAL(5, 41, 11), // "updateColor"
QT_MOC_LITERAL(6, 53, 5), // "index"
QT_MOC_LITERAL(7, 59, 11) // "updateStyle"

    },
    "BrushWidget\0brushChanged\0\0brush\0"
    "setBrush\0updateColor\0index\0updateStyle"
};
...
void BrushWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BrushWidget::*)(const QBrush & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BrushWidget::brushChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject BrushWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BrushWidget.data,
      qt_meta_data_BrushWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *BrushWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BrushWidget.stringdata0))
