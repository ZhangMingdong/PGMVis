...
QT_MOC_LITERAL(4, 36, 12), // "shearChanged"
QT_MOC_LITERAL(5, 49, 15), // "shearHorizontal"
QT_MOC_LITERAL(6, 65, 13), // "shearVertical"
QT_MOC_LITERAL(7, 79, 11) // "updateShear"

    },
    "TransformWidget\0angleChanged\0\0angle\0"
    "shearChanged\0shearHorizontal\0shearVertical\0"
    "updateShear"
};
...
void TransformWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->shearChanged((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 2: _t->updateShear(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TransformWidget::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransformWidget::angleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TransformWidget::*)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransformWidget::shearChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TransformWidget::angleChanged(double _t1)
{
...
// SIGNAL 1
void TransformWidget::shearChanged(double _t1, double _t2)
{
