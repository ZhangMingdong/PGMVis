...
QT_MOC_LITERAL(1, 15, 16), // "DrawGraphicsItem"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 14), // "IAbstractItem*"
QT_MOC_LITERAL(4, 48, 4), // "item"
QT_MOC_LITERAL(5, 53, 8), // "DrawLink"
QT_MOC_LITERAL(6, 62, 4), // "from"
QT_MOC_LITERAL(7, 67, 2), // "to"
QT_MOC_LITERAL(8, 70, 10), // "MousePress"
QT_MOC_LITERAL(9, 81, 12), // "MouseRelease"
QT_MOC_LITERAL(10, 94, 8), // "drawItem"
QT_MOC_LITERAL(11, 103, 1), // "b"
QT_MOC_LITERAL(12, 105, 12), // "viewShowGrid"
QT_MOC_LITERAL(13, 118, 2), // "on"
QT_MOC_LITERAL(14, 121, 6), // "zoomIn"
QT_MOC_LITERAL(15, 128, 7) // "zoomOut"

    },
    "MyGraphicsView\0DrawGraphicsItem\0\0"
    "IAbstractItem*\0item\0DrawLink\0from\0to\0"
    "MousePress\0MouseRelease\0drawItem\0b\0"
    "viewShowGrid\0on\0zoomIn\0zoomOut"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DrawGraphicsItem((*reinterpret_cast< IAbstractItem*(*)>(_a[1]))); break;
        case 1: _t->DrawLink((*reinterpret_cast< IAbstractItem*(*)>(_a[1])),(*reinterpret_cast< IAbstractItem*(*)>(_a[2]))); break;
        case 2: _t->MousePress(); break;
        case 3: _t->MouseRelease(); break;
        case 4: _t->drawItem((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->viewShowGrid((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MyGraphicsView::*)(IAbstractItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsView::DrawGraphicsItem)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyGraphicsView::*)(IAbstractItem * , IAbstractItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGraphicsView::DrawLink)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsView::DrawGraphicsItem(IAbstractItem * _t1)
{
...
// SIGNAL 1
void MyGraphicsView::DrawLink(IAbstractItem * _t1, IAbstractItem * _t2)
{
